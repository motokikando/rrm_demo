...
const pre_instruction1 = {
    ...
    pages: [
      '次の課題ではある形容詞が提示され、それが自身に当てはまるかどうか分類することが求められます。<br><img src="rrm_example1.png" width="500px" height="250px">',
      '下記の例のようにもし自身に当てはまるなら「i」キー (自分に当てはまる)をもし当てはまらないなら「eキー」(自分に当てはまらない)を押してください。<br><img src="rrm_example1.png" width="500px" height="250px">',
